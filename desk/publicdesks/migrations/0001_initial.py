    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('upload', models.ImageField(blank=True, null=True, upload_to='image/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time_in', models.DateTimeField(auto_now_add=True)),
                ('ann', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='anns', to='publicdesks.ann')),
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
